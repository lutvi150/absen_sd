  <div class="container-fluid">
      ...
      <ul class="navbar-nav ms-auto">
          ...
          <li hidden class="nav-item dropdown">
              ...
              <div hidden class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                      ...
                      <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                              ...
                              <p class="fs-7 text-secondary">
                                  <i class="bi bi-clock-fill me-1"></i> 4 Hours
                                  Ago
                              </p>
                          </div>
                      </div>
          ...
          <li class="nav-item dropdown user-menu">
              <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                  <img src="{{ asset('assets/images/login_user.jpeg') }}" class="user-image rounded-circle shadow"
                      alt="User Image">
                  <span class="d-none d-md-inline">Admin</span> </a>
              <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                  <!--begin::User Image-->
                  <li class="user-header text-bg-primary">
                      <img src="{{ asset('assets/images/login_user.jpeg') }}" class="rounded-circle shadow" alt="User Image">
                      <p>Admin<small>Admin Sistem</small></p>
                  </li>
                  <!--end::User Image-->
                  <!--begin::Menu Body-->
                  <li class="user-body">
